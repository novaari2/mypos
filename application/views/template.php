...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <!-- fungsi bawaan php ucfirst agar huruf pertama besar -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <li><<a href="<?= site_url('user')?>" title=""><i class="fa fa-user"></i><span>Users</span></a></li>
        <?php endif ?>
      </ul>
    </section>
    <!-- /.sidebar -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="https://adminlte.io">POS App</a>.</strong> All rights
    reserved.
  </footer>
